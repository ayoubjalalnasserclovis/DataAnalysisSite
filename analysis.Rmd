...
**Commentaire**: Cette régression examine l'effet du salaire moyen (`avg_wage`) sur le nombre de brevets (`n_patents`). Les coefficients et la significativité statistique sont présentés.
...
**Commentaire**: Cette régression analyse comment le nombre de brevets (`n_patents`) prédit le nombre d'offres d'emploi (`n_offres`).
...
**Commentaire**: Ce barplot montre les 10 descriptions principales IPC (`ipc_main_desc`) les plus fréquentes. Cela aide à identifier les domaines technologiques dominants.
